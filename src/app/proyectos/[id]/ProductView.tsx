  ...
  return (
    <section className="min-h-screen">
      <div className="px-4 sm:px-10 py-10 sm:py-20">
        <h1 className="text-4xl sm:text-6xl smd:text-7xl lg:text-8xl font-zodiak-bold text-brown-100">
          { title }
        </h1>
      ...
      <div className="grid grid-cols-4 mt-4 gap-4 px-12 pb-12">
        { photo_urls.map((url) => <img src={url} className="col-span-1" key={url} />)}
      </div>
      <div className="mt-4 w-2/3 px-12 py-12">
