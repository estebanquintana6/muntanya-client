export default function VerticalAbout() {
    return (
        <section className="min-h-[80vh] bg-primary flex flex-col">
            ...
            <div className="grid gap-1 grid-cols-12 font-zodiak-regular mt-4 p-11">
                <h2 className="text-2xl col-start-2 col-end-12 font-zodiak-bold">About</h2>
                <h3 className="text-lg col-start-3 col-end-9">This is Muntanya</h3>
                <h3 className="text-md col-start-4 col-end-12">
                ...
                <h3 className="text-sm col-start-6 col-end-10 font-zodiak-italic mt-2">Otra frase extra</h3>
            </div>
        </section>
    )
}