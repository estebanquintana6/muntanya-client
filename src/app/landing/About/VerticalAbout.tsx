        ...
        <section className="flex">
            <div className="w-full h-screen overflow-hidden relative">
                ...
                <div className="bg-black bg-opacity-60 backdrop-blur-sm h-full w-full sm:w-1/2 flex flex-col">
                    ...
                    <div className="flex w-full mb-auto mt-3 p-8 sm:p-0">
                        <div className="w-1/2 sm:w-52 ml-auto mr-4">
                            <h2 className="text-3xl text-primary ">Un estudio independiente de diseño</h2>
                        </div>
                        <div className="h-full border-l-4 border-primary" />
                        <h3 className="w-1/2 text-xl text-primary ml-4 mr-auto">Somos un estudio que hace x y z</h3>
                    </div>
                </div>
            </div>
        </section>
